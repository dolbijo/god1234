...
<body>
	...
	<div class="content-wrapper">
        <div class="container">
			<div class="row">
    			<div class="col-md-12">
    				<h4 class="page-head-line">채용 자료 검색</h4>
    			</div>
    		</div>
    		...
    		<div class="row">
    			<div class="col-md-12">
	                ...
	                <div class="alert alert-info">
	                    ...
	                    <input type="checkbox" name="ca" value="건설공사 기타"/>기타
	                </div>    
	                <div class="alert alert-info">
	            		<h4><strong>5.운송</strong></h4>               
