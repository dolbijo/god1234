			...
			<table style="width:600px;border:solid 1px;margin:0 auto">
	            <tr>
	                ...
	                <td style="width:50px;vertical-align:middle;padding-right:5px;padding-left:5px">
	                	<a class="btn btn-default" href="javascript:document.getElementById('commentform').submit();"
					...
					<c:forEach var="comment" items="${ freeboard.comments }">
						<tr>
			        		...
			        		<div id='commentview${comment.commentNo}'>
			                    ...
			                    <c:choose>
			                    <c:when test="${ loginuser.memberId == comment.memberId  }">
			                    ...
			                    <div style="display: ${display}">
			                    	<%-- <a class="btn btn-success" href="javascript:toggleCommentStatus(<%= bcomment.getCOMMENT_NUMBER() %>, true);">편집</a>
			                    	&nbsp;
			                    	<a class="btn btn-success" href="javascript:deleteComment(<%= bcomment.getCOMMENT_NUMBER() %>, <%= board.getB_NUMBER() %>, <%= request.getAttribute("pageno") %>)">삭제</a>
			                     --%>
			                    </div>
			                </div>
			                ...
			                <div id='commentedit${comment.commentNo}' style="display: none">
								...
								[${comment.regdate}] 
								<br /><br />
								<form id="commenteditform${comment.commentNo}" 
								...
								<br />
								<div>
									<%-- <a class="btn btn-default" href="javascript:document.getElementById('commenteditform<%= bcomment.getCOMMENT_NUMBER() %>').submit();">수정</a> 
									&nbsp; 
									<a class="btn btn-default" href="javascript:toggleCommentStatus(<%= bcomment.getCOMMENT_NUMBER() %>, false);">취소</a>
								 --%>
								</div>
							</div>
